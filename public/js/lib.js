			...
			function addSchema(schemaSrc) {
				...
				if (!schemata[schemaSrc.type]) {
					...
					schema = {
						type: schemaSrc.type,
						name: schemaSrc.name,
						plural: schemaSrc.plural,
						key: schemaSrc.key,
						members: schemaSrc.members,
						onSet: schemaSrc.onSet,
						onSave: schemaSrc.onSave,
						collectionEvents: schemaSrc.collectionEvents,
						fullSave: schemaSrc.fullSave,
						shallowSave: schemaSrc.shallowSave,
						incremental: schemaSrc.incremental,
						bubbleEvents: schemaSrc.bubbleEvents,
						recOfArrays: schemaSrc.recOfArrays
					};
